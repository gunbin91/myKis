...
- **Source**: `OAuth인증.xlsx` / sheet `접근토큰폐기(P)`
- **API ID**: `인증-002`
- **통신방식**: **REST**
- **HTTP Method**: `POST`
- **URL**: `/oauth2/revokeP`
