...
- **Source**: `(해외주식) 시세분석.xlsx` / sheet `해외속보(제목)`
- **API ID**: `해외주식-055`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
