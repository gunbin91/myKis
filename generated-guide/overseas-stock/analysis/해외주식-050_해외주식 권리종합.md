...
- **Source**: `(해외주식) 시세분석.xlsx` / sheet `해외주식 권리종합`
- **API ID**: `해외주식-050`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
