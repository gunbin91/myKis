...
- **Source**: `(해외주식) 기본시세.xlsx` / sheet `해외주식 체결추이`
- **API ID**: `해외주식-037`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
...
| Request Query Parameter | EXCD | 거래소명 | string | Y | 4 | 'NYS : 뉴욕, NAS : 나스닥,  AMS : 아멕스  HKS : 홍콩, SHS : 상해 , SZS : 심천 HSX : 호치민, HNX : 하노이 TSE : 도쿄 ' |
