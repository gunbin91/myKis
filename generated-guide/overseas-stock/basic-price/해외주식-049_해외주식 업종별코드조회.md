...
- **Source**: `(해외주식) 기본시세.xlsx` / sheet `해외주식 업종별코드조회`
- **API ID**: `해외주식-049`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | AUTH: EXCD:NAS |  |  |  |  |  |
| Response Example | {     "output1": {         "nrec": "42"     },     "output2": [         {             "icod": "000",             "name": "전체"         },         {             "icod": "010",             "name": "에너지 및 관련 서비스"         },...     ],     "rt_cd": "0",     "msg_cd": "MCA00000",     "msg1": "정상처리 되었습니다." } |  |  |  |  |  |
