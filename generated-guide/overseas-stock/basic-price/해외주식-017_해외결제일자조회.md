...
- **Source**: `(해외주식) 기본시세.xlsx` / sheet `해외결제일자조회`
- **API ID**: `해외주식-017`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
