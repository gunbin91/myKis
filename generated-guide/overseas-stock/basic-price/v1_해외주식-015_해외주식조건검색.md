...
- **Source**: `(해외주식) 기본시세.xlsx` / sheet `해외주식조건검색`
- **API ID**: `v1_해외주식-015`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
