...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 미국주간정정취소`
- **API ID**: `v1_해외주식-027`
- **통신방식**: **REST**
- **HTTP Method**: `POST`
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | {     "CANO": "12345678",     "ACNT_PRDT_CD": "01",     "OVRS_EXCG_CD": "NASD",     "PDNO": "AMZN",     "ORGN_ODNO": "0000034436",     "RVSE_CNCL_DVSN_CD": "01",     "ORD_QTY": "111",     "OVRS_ORD_UNPR": "1.9",     "CTAC_TLNO": "",     "MGCO_APTM_ODNO": "",     "ORD_SVR_DVSN_CD": "0" } |  |  |  |  |  |
| Response Example | {     "rt_cd": "0",     "msg_cd": "APBK0013",     "msg1": "주문 전송 완료 되었습니다.",     "output": {         "KRX_FWDG_ORD_ORGNO": "01790",         "ODNO": "0000034437",         "ORD_TMD": "104202"     } } |  |  |  |  |  |
