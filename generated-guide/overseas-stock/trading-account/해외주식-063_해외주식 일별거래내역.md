...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 일별거래내역`
- **API ID**: `해외주식-063`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
