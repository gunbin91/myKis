...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 매수가능금액조회`
- **API ID**: `v1_해외주식-014`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
...
실전 테스트 메모: ITEM_CD에 티커(AAPL) 입력은 정상 응답, std_pdno(12자리) 입력은 APBN0746(상품정보 없음) 응답을 확인함.
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | "input": {             "ACNT_PRDT_CD": "01",             "CANO": "81019777",             "ITEM_CD": "00011",             "OVRS_EXCG_CD": "SEHK",             "OVRS_ORD_UNPR": "133.200"         } |  |  |  |  |  |
| Response Example | "output": {             "echm_af_ord_psbl_amt": "0.00",             "echm_af_ord_psbl_qty": "0",             "exrt": "165.5400000000",             "frcr_ord_psbl_amt1": "955**.12",             "max_ord_psbl_qty": "744**",             "ord_psbl_frcr_amt": "999**.52",             "ord_psbl_qty": "744**",             "ovrs_max_ord_psbl_qty": "717**",             "ovrs_ord_psbl_amt": "992**.35",             "sll_ruse_psbl_amt": "0.00",             "tr_crcy_cd": "HKD"         } |  |  |  |  |  |
