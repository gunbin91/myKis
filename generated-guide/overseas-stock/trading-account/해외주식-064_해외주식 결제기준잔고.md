...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 결제기준잔고`
- **API ID**: `해외주식-064`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
