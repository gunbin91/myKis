...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 체결기준현재잔고`
- **API ID**: `v1_해외주식-008`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
