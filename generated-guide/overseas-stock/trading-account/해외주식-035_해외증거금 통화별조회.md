...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외증거금 통화별조회`
- **API ID**: `해외주식-035`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
