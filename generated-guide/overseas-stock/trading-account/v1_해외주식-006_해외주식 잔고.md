...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 잔고`
- **API ID**: `v1_해외주식-006`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
