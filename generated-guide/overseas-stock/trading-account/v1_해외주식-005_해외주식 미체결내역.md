...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 미체결내역`
- **API ID**: `v1_해외주식-005`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
