...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 지정가체결내역조회`
- **API ID**: `해외주식-070`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | CANO:12345678 ACNT_PRDT_CD:01 ORD_DT:20250523 ORD_GNO_BRNO: ODNO:0031112345 TTLZ_ICLD_YN: CTX_AREA_NK200: CTX_AREA_FK200: |  |  |  |  |  |
