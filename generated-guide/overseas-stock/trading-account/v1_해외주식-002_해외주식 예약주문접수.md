...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 예약주문접수`
- **API ID**: `v1_해외주식-002`
- **통신방식**: **REST**
- **HTTP Method**: `POST`
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | { "CANO": "810XXXXX", "ACNT_PRDT_CD":"AAPL", "PDNO": "AAPL", "OVRS_EXCG_CD": "NASD", "FT_ORD_QTY": "1", "FT_ORD_UNPR3": "148.00" } |  |  |  |  |  |
| Response Example | {   "rt_cd": "0",   "msg_cd": "APBK0013",   "msg1": "주문 전송 완료 되었습니다.",   "output": {     "ODNO": "0030138295"   } } |  |  |  |  |  |
