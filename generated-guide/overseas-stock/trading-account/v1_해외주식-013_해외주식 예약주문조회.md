...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 예약주문조회`
- **API ID**: `v1_해외주식-013`
- **통신방식**: **REST**
- **HTTP Method**: `GET`
