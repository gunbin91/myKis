...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 예약주문접수취소`
- **API ID**: `v1_해외주식-004`
- **통신방식**: **REST**
- **HTTP Method**: `POST`
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | { "CANO": "810XXXXX", "ACNT_PRDT_CD": "01", "RSVN_ORD_RCIT_DT": "20211124", "OVRS_RSVN_ODNO": "30135682" } |  |  |  |  |  |
| Response Example | {   "rt_cd": "0",   "msg_cd": "APBK1711",   "msg1": "취소주문이 접수되었습니다.",   "output": {     "OVRS_RSVN_ODNO": "0030138295"   } } |  |  |  |  |  |
