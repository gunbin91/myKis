...
- **Source**: `(해외주식) 주문_계좌.xlsx` / sheet `해외주식 주문`
- **API ID**: `v1_해외주식-001`
- **통신방식**: **REST**
- **HTTP Method**: `POST`
...
| Example |  |  |  |  |  |  |
| Request Example (Python) | { "CANO": "810XXXXX", "ACNT_PRDT_CD": "01", "OVRS_EXCG_CD": "NASD", "PDNO": "AAPL", "ORD_QTY": "1", "OVRS_ORD_UNPR": "145.00", "CTAC_TLNO": "", "MGCO_APTM_ODNO": "", "ORD_SVR_DVSN_CD": "0", "ORD_DVSN": "00" } |  |  |  |  |  |
| Response Example | {   "rt_cd": "0",   "msg_cd": "APBK0013",   "msg1": "주문 전송 완료 되었습니다.",   "output": {     "KRX_FWDG_ORD_ORGNO": "01790",     "ODNO": "0000004336",     "ORD_TMD": "160524"   } } |  |  |  |  |  |
